...
<center>
<fieldset>
        <h1>Get youtub video id</h1>
<form action="" method="POST">


<input type="text" name="url" placeholder=""/><br>


<input type="submit" name="submit" value="Get Youtube Video Id ">
...
<head>
<title></title>
<meta content='get youtube video id' name='Description'/>
